...
class LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf4(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf4 - a model defined in OpenAPI
