...
class LeadsPricingTemplatesGet200ResponseDataInnerValuesInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsPricingTemplatesGet200ResponseDataInnerValuesInner - a model defined in OpenAPI
