...
class LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf - a model defined in OpenAPI
