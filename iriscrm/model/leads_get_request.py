...
def lazy_import():
    ...
    globals()['LeadsGetRequestFieldsInner'] = LeadsGetRequestFieldsInner


class LeadsGetRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fields': ([LeadsGetRequestFieldsInner],),  # noqa: E501
            'campaign': (int,),  # noqa: E501
            'source': (int,),  # noqa: E501
            'group': (int,),  # noqa: E501
            'users': ([int],),  # noqa: E501
            'users_emails': ([str],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'users_emails': 'users_emails',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, fields, *args, **kwargs):  # noqa: E501
        """LeadsGetRequest - a model defined in OpenAPI

        Args:
            status (int): Status Id
            fields ([LeadsGetRequestFieldsInner]): Lead fields
        ...
        Keyword Args:
            ...
            campaign (int): Campaign Id. [optional]  # noqa: E501
            source (int): Source Id. [optional]  # noqa: E501
            group (int): Group Id. [optional]  # noqa: E501
            users ([int]): Ids of users to assign to a new lead. [optional]  # noqa: E501
            users_emails ([str]): Emails of users to assign to a new lead. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, fields, *args, **kwargs):  # noqa: E501
        """LeadsGetRequest - a model defined in OpenAPI
