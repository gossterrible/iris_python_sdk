...
def lazy_import():
    ...
    globals()['LeadAppointment'] = LeadAppointment
    globals()['Links'] = Links
    globals()['Meta'] = Meta


class LeadsLeadIdAppointmentsGet200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([LeadAppointment],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdAppointmentsGet200Response - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ([LeadAppointment]): [optional]  # noqa: E501
