...
class LeadsLeadIdAppointmentsGetRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, date_end, text, set_by, set_for, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdAppointmentsGetRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, date_end, text, set_by, set_for, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdAppointmentsGetRequest - a model defined in OpenAPI
