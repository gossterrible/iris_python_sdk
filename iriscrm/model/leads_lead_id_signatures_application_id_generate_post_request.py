...
class LeadsLeadIdSignaturesApplicationIdGeneratePostRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdSignaturesApplicationIdGeneratePostRequest - a model defined in OpenAPI
