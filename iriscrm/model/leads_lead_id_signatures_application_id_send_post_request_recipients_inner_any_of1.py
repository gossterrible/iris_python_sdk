...
class LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf1(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf1 - a model defined in OpenAPI
