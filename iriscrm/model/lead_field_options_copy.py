...
class LeadFieldOptionsCopy(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'title': (str,),  # noqa: E501
            '_from': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'to': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadFieldOptionsCopy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            title (str): Button label. [optional]  # noqa: E501
            _from ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Copy from. [optional]  # noqa: E501
            to ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Copy to. [optional]  # noqa: E501
        """
