...
class LeadsLeadIdNotesGetRequest(ModelNormal):
    ...
    attribute_map = {
        ...
        'notify_users': 'notify_users',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tab, note, sticky, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdNotesGetRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            notify_users (str): Comma separated list of user ids to notify or `all_assigned` to notify all users assigned to the lead. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, tab, note, sticky, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdNotesGetRequest - a model defined in OpenAPI
