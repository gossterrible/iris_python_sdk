...
class Meta(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            current_page (int): The current page number of a data set. [optional]  # noqa: E501
            _from (int): The current position of a data set . [optional]  # noqa: E501
            last_page (str): The last page of a data set. [optional]  # noqa: E501
            path (str): API path. [optional]  # noqa: E501
            per_page (int): A number of records per page. [optional]  # noqa: E501
            to (int): The last position in a data set. [optional]  # noqa: E501
            total (int): Total number of records in a data set. [optional]  # noqa: E501
        """
