...
def lazy_import():
    ...
    globals()['DeletionActivity'] = DeletionActivity
    globals()['Links'] = Links
    globals()['Meta'] = Meta


class LeadsLeadIdActivityDeletionGet200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([DeletionActivity],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdActivityDeletionGet200Response - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ([DeletionActivity]): [optional]  # noqa: E501
