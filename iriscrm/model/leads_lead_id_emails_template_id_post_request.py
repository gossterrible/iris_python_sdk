...
def lazy_import():
    ...
    globals()['LeadsLeadIdEmailsTemplateIdPostRequestOneOf'] = LeadsLeadIdEmailsTemplateIdPostRequestOneOf
    globals()['LeadsLeadIdEmailsTemplateIdPostRequestOneOf1'] = LeadsLeadIdEmailsTemplateIdPostRequestOneOf1


class LeadsLeadIdEmailsTemplateIdPostRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'placeholders': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'email': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdEmailsTemplateIdPostRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            placeholders ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Object with template placeholders. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              LeadsLeadIdEmailsTemplateIdPostRequestOneOf,
              LeadsLeadIdEmailsTemplateIdPostRequestOneOf1,
          ],
        }
