...
class LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf3(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdSignaturesApplicationIdSendPostRequestRecipientsInnerAnyOf3 - a model defined in OpenAPI
