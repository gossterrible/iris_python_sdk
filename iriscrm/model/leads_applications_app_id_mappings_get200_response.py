...
def lazy_import():
    ...
    globals()['ApplicationField'] = ApplicationField
    globals()['Links'] = Links
    globals()['Meta'] = Meta


class LeadsApplicationsAppIdMappingsGet200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ApplicationField],),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LeadsApplicationsAppIdMappingsGet200Response - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data ([ApplicationField]): [optional]  # noqa: E501
