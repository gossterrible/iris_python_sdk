...
class LeadFieldOrder(ModelNormal):
    ...
    def _from_openapi_data(cls, value, *args, **kwargs):  # noqa: E501
        """LeadFieldOrder - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of changing order position. [optional] if omitted the server will use the default value of "null"  # noqa: E501
        """
