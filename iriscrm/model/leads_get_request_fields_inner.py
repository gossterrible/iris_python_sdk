...
class LeadsGetRequestFieldsInner(ModelNormal):
    ...
    def _from_openapi_data(cls, id, value, *args, **kwargs):  # noqa: E501
        """LeadsGetRequestFieldsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            record (str): Record Id. [optional]  # noqa: E501
        """
