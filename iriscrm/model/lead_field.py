...
class LeadField(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tab, label, type, *args, **kwargs):  # noqa: E501
        """LeadField - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tab, label, type, *args, **kwargs):  # noqa: E501
        """LeadField - a model defined in OpenAPI
