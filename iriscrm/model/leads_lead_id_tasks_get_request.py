...
class LeadsLeadIdTasksGetRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'text': (str,),  # noqa: E501
            'set_by': (str,),  # noqa: E501
            'set_for': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, priority, date, date_end, text, set_by, set_for, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdTasksGetRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, priority, date, date_end, text, set_by, set_for, *args, **kwargs):  # noqa: E501
        """LeadsLeadIdTasksGetRequest - a model defined in OpenAPI
