...
class Links(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            first (str): An URL to the first page of the data set. [optional]  # noqa: E501
            last (str): An URL to the last page of the data set. [optional]  # noqa: E501
            prev (str): An URL to the previous page of the data set. [optional]  # noqa: E501
            next (str): An URL to the next page of the data set. [optional]  # noqa: E501
        """
