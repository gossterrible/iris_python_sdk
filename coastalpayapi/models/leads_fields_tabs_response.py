...
class LeadsFieldsTabsResponse(object):

    """Implementation of the 'Leads Fields Tabs Response' model.

    TODO: type model description here.

    Attributes:
        data (list of LeadFieldTab): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsFieldsTabsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [LeadFieldTab.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
