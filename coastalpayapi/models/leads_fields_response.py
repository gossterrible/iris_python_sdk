...
class LeadsFieldsResponse(object):

    """Implementation of the 'Leads Fields Response' model.

    TODO: type model description here.

    Attributes:
        data (list of LeadField): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsFieldsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [LeadField.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
