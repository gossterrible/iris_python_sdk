...
from coastalpayapi.models.duplicate_activity import DuplicateActivity
...
class LeadsActivityDuplicatesResponse(object):

    """Implementation of the 'Leads Activity Duplicates Response' model.

    TODO: type model description here.

    Attributes:
        data (list of DuplicateActivity): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsActivityDuplicatesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [DuplicateActivity.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
