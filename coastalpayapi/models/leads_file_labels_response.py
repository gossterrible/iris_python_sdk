...
from coastalpayapi.models.file_label import FileLabel
...
class LeadsFileLabelsResponse(object):

    """Implementation of the 'Leads File Labels Response' model.

    TODO: type model description here.

    Attributes:
        data (list of FileLabel): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsFileLabelsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [FileLabel.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
