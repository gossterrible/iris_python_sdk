...
class LeadsApplicationsMappingsResponse1(object):

    """Implementation of the 'Leads Applications Mappings Response1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LeadsApplicationsMappingsResponse1 class"""
