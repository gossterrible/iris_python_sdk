...
class LeadsRecordsRecordIdResponse(object):

    """Implementation of the 'Leads Records RecordId Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the LeadsRecordsRecordIdResponse class"""
