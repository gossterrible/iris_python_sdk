...
from coastalpayapi.models.campaign_activity import CampaignActivity
...
class LeadsActivityCampaignResponse(object):

    """Implementation of the 'Leads Activity Campaign Response' model.

    TODO: type model description here.

    Attributes:
        data (list of CampaignActivity): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsActivityCampaignResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [CampaignActivity.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
