...
class LeadsSourcesResponse(object):

    """Implementation of the 'Leads Sources Response' model.

    TODO: type model description here.

    Attributes:
        data (list of BriefSourceInfo): A list of lead sources
    ...
    def __init__(self,
                 data=APIHelper.SKIP):
        """Constructor for the LeadsSourcesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [BriefSourceInfo.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
