...
class LeadsResponse1(object):

    """Implementation of the 'Leads Response1' model.

    TODO: type model description here.

    Attributes:
        data (list of BriefLeadInfo): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsResponse1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [BriefLeadInfo.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
