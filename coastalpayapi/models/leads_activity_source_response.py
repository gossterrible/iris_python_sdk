...
from coastalpayapi.models.source_activity import SourceActivity
import os
from coastalpayapi.utilities.schema_validator_wrapper import SchemaValidatorWrapper
from jsonschema import ValidationError


class LeadsActivitySourceResponse(object):

    """Implementation of the 'Leads Activity Source Response' model.

    TODO: type model description here.

    Attributes:
        data (list of SourceActivity): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsActivitySourceResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [SourceActivity.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
