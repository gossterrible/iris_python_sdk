...
from coastalpayapi.models.deletion_activity import DeletionActivity
...
class LeadsActivityDeletionResponse(object):

    """Implementation of the 'Leads Activity Deletion Response' model.

    TODO: type model description here.

    Attributes:
        data (list of DeletionActivity): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsActivityDeletionResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [DeletionActivity.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
