...
class LeadsEmailsResponse(object):

    """Implementation of the 'Leads Emails Response' model.

    TODO: type model description here.

    Attributes:
        message (string): Email has been sent successfully
        email_id (string): Id of email what will be sended to lead
    ...
    def __init__(self,
        ...
        """Constructor for the LeadsEmailsResponse class"""
