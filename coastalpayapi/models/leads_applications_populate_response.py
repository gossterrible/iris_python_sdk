...
class LeadsApplicationsPopulateResponse(object):

    """Implementation of the 'Leads Applications Populate Response' model.
    ...
    def __init__(self,
                 ...
                 url=APIHelper.SKIP):
        """Constructor for the LeadsApplicationsPopulateResponse class"""
