...
from coastalpayapi.models.lead_field_value import LeadFieldValue
import os
...
class Items(object):
    ...
    Attributes:
        ...
        fields (list of LeadFieldValue): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('fields') is not None:
            fields = [LeadFieldValue.from_dictionary(x) for x in dictionary.get('fields')]
        else:
            fields = APIHelper.SKIP
