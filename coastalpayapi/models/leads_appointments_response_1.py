...
from coastalpayapi.models.lead_appointment import LeadAppointment
...
class LeadsAppointmentsResponse1(object):

    """Implementation of the 'Leads Appointments Response1' model.

    TODO: type model description here.

    Attributes:
        data (list of LeadAppointment): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsAppointmentsResponse1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [LeadAppointment.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
