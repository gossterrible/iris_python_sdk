...
from coastalpayapi.models.datum_4 import Datum4
...
class LeadsSignaturesResponse(object):

    """Implementation of the 'Leads Signatures Response' model.

    TODO: type model description here.

    Attributes:
        data (list of Datum4): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsSignaturesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [Datum4.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
