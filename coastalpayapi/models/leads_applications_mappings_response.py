...
class LeadsApplicationsMappingsResponse(object):

    """Implementation of the 'Leads Applications Mappings Response' model.

    TODO: type model description here.

    Attributes:
        data (list of ApplicationField): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsApplicationsMappingsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [ApplicationField.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
