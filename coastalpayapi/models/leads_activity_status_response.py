...
from coastalpayapi.models.status_activity import StatusActivity
import os
from coastalpayapi.utilities.schema_validator_wrapper import SchemaValidatorWrapper
from jsonschema import ValidationError


class LeadsActivityStatusResponse(object):

    """Implementation of the 'Leads Activity Status Response' model.

    TODO: type model description here.

    Attributes:
        data (list of StatusActivity): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 meta=APIHelper.SKIP):
        """Constructor for the LeadsActivityStatusResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') is not None:
            data = [StatusActivity.from_dictionary(x) for x in dictionary.get('data')]
        else:
            data = APIHelper.SKIP
