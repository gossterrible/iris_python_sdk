...
from coastalpayapi.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    def clone_with(self, http_client_instance=None,
        ...
        return Configuration(
            ...
            environment=environment, x_api_key=x_api_key
        )
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'https://www.mycoastalpay.com/api/v1'
        }
    }
